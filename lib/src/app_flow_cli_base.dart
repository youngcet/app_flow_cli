...
''';
  ...
  static String _getMetaData() {
    ...
    final buffer = StringBuffer()
      ...
      ..writeln('// Project: ${_getProjectPubSpecValue('name')}');
  ...
  static dynamic _getProjectPubSpecValue(String key) {
  ...
  static Future<void> status() async {
    ...
    if (await file.exists()) {
      ...
      final buffer = StringBuffer()
        ...
        ..writeln('// Project: ${_getProjectPubSpecValue('name')} (v${_getProjectPubSpecValue('version')})')
